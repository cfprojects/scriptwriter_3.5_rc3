<cfscript>
	...
	if (fb_.verbInfo.executionMode is "start")
	{
		...
		if (NOT StructKeyExists(fb_.verbInfo.attributes,"outputPath")) {
			fb_throw(
				"fusebox.badGrammar.requiredAttributeMissing",
				"Required attribute is missing",
				"The attribute 'outputPath' is required, for a 'scriptwriter' verb in fuseaction #fb_.verbInfo.circuit#.#fb_.verbInfo.fuseaction#."
			);
		}
	
		fb_.verbInfo.output = "<cfset #fb_.verbInfo.attributes.factory#.combine(";
